...
namespace FoodDiary.Migrations
{
    ...
    [Migration("20230206070301_Add_Gender_and_PhyssicalActivity_Entities")]
    partial class AddGenderandPhyssicalActivityEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodDiary.Data.Entities.PhysicalActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDiary.Data.Entities.Sex", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDiary.Data.Entities.User", b =>
                {
                    b.HasOne("FoodDiary.Data.Entities.PhysicalActivity", "PhysicalActivity")
                        .WithMany("Users")
                        .HasForeignKey("PhysicalActivityId");

                    b.HasOne("FoodDiary.Data.Entities.Sex", "Sex")
                        .WithMany("Users")
                        .HasForeignKey("SexId");
